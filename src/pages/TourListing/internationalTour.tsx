...
function Main() {
   ...
   const getItineraryData = ()=>{
      const data = callApi(API, "GET", `super-itinerary-master/itinerary-international`, '').then((result)=>{
         ...
         <div className="bg-white overflow-hidden">
            ...
            <div className="trip_by_destination_section my-14">
               <div className="container">
                  <h2 className="text-3xl font-bold text-black text-center mb-8">All International Tour</h2>
