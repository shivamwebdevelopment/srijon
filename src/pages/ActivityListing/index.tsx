        ...
        <div className="container px-4 md:px-4 py-3">
          <div className="flex flex-col lg:flex-row gap-6 p-4 shadow-xl rounded-lg border">
            ...
            <div className="flex-1">
              ...
              <h2 className="text-2xl font-semibold mt-4">Jai Hind</h2>
              <p className="text-gray-600 border-b pb-4">New Delhi</p>
              ...
              {/* Place Offers */}
              {/* <div className="text-sm  py-4 border-b mb-4">
              ...
              <div className="flex flex-col  gap-4 pt-4">
                ...
                <div className="border flex-grow rounded-lg p-4 flex flex-col md:flex-row justify-between">
                  <div>
                    <h2 className="font-semibold text-lg">
                      Jai Hind Show : Category A
                    </h2>
                    <div className="flex items-center text-[12px] text-gray-700 font-semibold mt-1 gap-x-3 flex-wrap">
                      <span className="flex items-center gap-1">
                        <FaClock className="text-[#F97316]" /> 1 Hour (approx.)
                      </span>
                    </div>
                    <ul className="text-sm mt-2 list-disc ml-4">
                      <li>1st Show: 6:30 PM in Hindi</li>
                      <li>
                        2nd Show: 7:45 PM English (Tuesday-Wednesday-Thursday) &
                        Hindi (Friday-Saturday-Sunday)
                      </li>
                    </ul>
                  </div>
                ...
                <div className="border flex-grow rounded-lg p-4 flex flex-col md:flex-row justify-between">
                  ...
                  <div className="text-right mt-4 md:mt-0">
                    <p className="text-2xl font-bold">₹1,629</p>
                    <button className="mt-2 bg-primary text-white px-4 py-2 rounded">
                      BOOK NOW
                    </button>
                  </div>
            ...
            <div className="w-full lg:w-1/3">
              ...
              <div className="p-4 border rounded-xl shadow-sm mb-4">
                ...
                <div className="flex justify-between items-start">
                  ...
                  <p className="border border-gray border-b-2 rounded-md px-3 py-1">
                    <strong> End Time :</strong> 11:00 am
                  </p>
                </div>
