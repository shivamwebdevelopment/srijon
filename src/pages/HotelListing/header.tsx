...
const Header = (props) => {
  ...
  return (
    <>
      <div className="header_section fixed top-0 left-0 w-full z-50 flex px-2 py-3 bg-white md:px-8 lg:flex shadow">
      ...
      <PreviewComponent className="mt-[92px] intro-y box">
        <div className="p-0">
          <Preview>
            <Dialog
              size="xl"
