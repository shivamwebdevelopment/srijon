...
const destinations = [
  {
    link: "/destination/bangkok-pattaya",
    ...
    <>
      ...
      <div className="bg-white overflow-hidden">
        ...
        <div className="relative w-full ">
          {/* Desktop Background */}
          <div
            className="w-full h-[400px] bg-fixed md:h-[300px] bg-cover bg-bottom hidden md:block"
            style={{
              backgroundImage:
                'url("https://images.pexels.com/photos/4319877/pexels-photo-4319877.jpeg?_gl=1*1nqbert*_ga*MTQxNzM2OTIyNi4xNzEwNzc4MTgz*_ga_8JE65Q40S6*czE3NTcxMzg2MzEkbzQ3JGcxJHQxNzU3MTM4ODY1JGo0NyRsMCRoMA..")',
            }}
          >
        ...
        <div className="trip_by_destination_section mt-14">
          <div className="container">
            <div className="px-4 md:px-16 py-8 ">
              <h2 className="text-[15px] sm:text-2xl font-semibold mb-6">
                Create Experiences with Top Activities
              </h2>
