...
function Main() {
  ...
  const fetchData = (value = "", flt = "", limit = 50, pageNo = 0) => {
    ...
    const res = axios
      .get(
        `${server}super-transport-master/front/get-all-transport/bus${dataStr}${filter}${dataLimit}${dataPageNo}`
      )
      .then((response) => {
      ...
      <div className="bg-white overflow-hidden relative">
        ...
        <BrowserView>
          <div className="banner_section relative bg-cover bg-bottom">
            <img alt="Banner" className="w-full" src={bannerImage} />
                ...
                <div className="w-3/4">
                  ...
                  <div className="review_main_wrap p-4 rounded-lg bg-white border-slate-200 border-solid border shadow-lg mb-4">
                    <div className="flex justify-between items-center">
                      <div>
                        <h3 className="text-[18px] font-semibold pb-1">
                            ...
                            <div className="form_container flex justify-center align-center">
                              ...
                              <div className="form_container flex justify-center align-center">
                                <div className="form_field_area mt-0">
                                  <input
                                    className="text-sm font-medium uppercase bg-orange-500 py-2 px-10 rounded-full text-white hover:bg-black cursor-pointer"
                                    type="submit"
                                    value="SEARCH"
                                  />
                                </div>
