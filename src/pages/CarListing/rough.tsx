...
const filters = [
  { id: "ac", label: "AC (25)" },
  { id: "sleeper", label: "SLEEPER (24)" },
  { id: "single", label: "Single Seats (20)" },
  { id: "seater", label: "SEATER (19)" },
  { id: "nonac", label: "NONAC (6)" },
  { id: "evening", label: "18:00-24:00 (24)" },
  { id: "morning", label: "06:00-12:00 (0)", disabled: true },
  { id: "rated", label: "High Rated Buses (16)" },
  { id: "tracking", label: "Live Tracking (11)" },
  { id: "volvo", label: "Volvo Buses (1)" },
];
...
function Main() {
  ...
  const filteredBuses = activeFilters.flatMap(
    (filter) => busData[filter] || []
  );
  return (
    <>
      {/* HEADER SECTION TWO */}
          ...
          <div className="container">
            <div className="flex min-h-screen bg-gray-50 p-6">
              ...
              <div className="w-64 bg-white p-4 rounded-xl shadow-md">
                <h2 className="font-semibold text-lg mb-3">Filter buses</h2>
                <button
              ...
              <div className="flex-1 ml-6 space-y-4">
                {filteredBuses.length === 0 ? (
                  <p className="text-gray-500">Select filters to view buses.</p>
                ) : (
                  filteredBuses.map((bus) => (
                    ...
                    >
                      <div>
                        ...
                        <p className="text-gray-600 text-sm">{bus.seats}</p>
                      </div>
                      <div className="text-right">
                        ...
                        <p className="text-xl font-semibold">{bus.price}</p>
                        {bus.discount && (
                          <p className="bg-yellow-300 text-yellow-900 text-xs px-2 py-1 rounded inline-block mt-1">
                            {bus.discount}
                          </p>
                        )}
