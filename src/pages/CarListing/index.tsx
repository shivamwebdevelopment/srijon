...
const filters = [
  ...
  { id: "Micro Cars", label: "Micro Cars (16)" },
  { id: "Luxury Cars", label: "Luxury Cars (11)" },
  { id: "Sports Cars", label: "Sports Cars (1)" },
];
...
// Flatten all carData for default "all cars" view
...
function Main() {
  ...
  const filteredcars =
    activeFilters.length === 0
      ? allcars // show all cars initially
      : activeFilters.flatMap((filter) => carData[filter] || []);
  //   Card Filter :: end
  ...
  return (
    <>
      ...
      <div className="bg-white overflow-hidden">
        ...
        <div className="flex justify-between w-full container mx-auto relative flex-col gap-0 md:flex-row">
          {/* Left: Cars Details */}
          <div className="w-full mt-14">
            <div className="min-h-screen  p-4">
              <div className="flex flex-col md:flex-row gap-4">
                {/* Sidebar (filters) */}
                <div className="md:w-56 bg-white p-4 rounded-xl shadow-md sticky top-4">
                  <h2 className="font-semibold text-lg mb-3">Filter cars</h2>
                  <button
                ...
                <div className="flex-1 space-y-4">
                  {filteredcars.length === 0 ? (
                    ...
                    filteredcars.map((car) => (
                      <div
                        key={car.id}
                        className="bg-white max-w-full p-4 rounded-xl shadow-md flex flex-col md:flex-row md:items-center md:justify-between gap-4"
                      >
                        {/* Car Image */}
                        <div className="flex flex-col items-center  md:justify-start">
                          <img
                            className="w-[100px] h-full"
                            src="https://static.vecteezy.com/system/resources/previews/025/305/916/large_2x/white-sport-car-on-transparent-background-3d-rendering-illustration-free-png.png"
                            alt=""
                          />
                          <div className="flex flex-col mt-[-20px] items-center flex-1">
                        ...
                        <div className="flex-2">
                          ...
                          <p className="text-[11.5px] flex gap-1 items-center text-gray-700">
                        ...
                        <div className="text-right flex-1">
                          ...
                          <button className="mt-2 whitespace-nowrap bg-[#F97316] text-white text-[12px] px-3 py-1 rounded-lg hover:bg-black w-full md:w-auto">
                            View seats
                          </button>
                        </div>
                      </div>
          ...
          {/* Right: Map Embed */}
          <div className="w-full mt-12  md:w-[600px]  ">
            <div className="   md:pr-4 pt-4 ">
              <iframe
                className="md:h-[calc(100vh-12rem)] h-[300px]  w-full  rounded-3xl "
