            ...
            <div className="header_section flex-initial px-2 py-3 bg-white md:flex-initial md:px-8 lg:flex">
               <div className="logo_area text-center mb-4 w-full md:w-full md:text-left md:mb-0 lg:w-1/5">
                  <Link to="/">
                     <img
                        alt="Logo"
                        className="inline-block md:block md:my-0 md:mx-auto lg:my-0 lg:mx-0"
                        src={siteLogo}
                     />
                  </Link>
               </div>
               <div className="header_right_area w-full md:w-full md:mt-4 lg:w-4/5">
                  <div className="header_right_top flex justify-end py-4">
                     ...
                     <div className="account_section ml-4 md:ml-6">
                        <Link
                           className="bg-orange-500 rounded-full text-sm font-medium text-white px-4 py-2  hover:bg-black md:px-6"
                           as="a"
                           href="#"
                           variant="primary"
                  ...
                  <div className="main_menu py-3 hidden md:block sticky top-0">
