...
function Main() {
  ...
  //  NEW: Trip destination image card :: Start
  const packages = [
    {
      title: "Thimphu, Punakha, Paro 8N 9D",
      duration: "8 Nights 9 Days",
      price: "₹ 41513",
      image: "https://images.unsplash.com/photo-1551524164-687a55dd1126", // sample
      highlights: [
        "Betaab Valley",
        "Aru Valley",
        "Sonmarg",
    ...
    {
      title: "PAHALGAM, SRINAGAR 5N 6D",
      duration: "5 Nights 6 Days",
      price: "₹ 17088",
      image: "https://images.unsplash.com/photo-1548013146-72479768bada", // sample
      highlights: ["Betaab Valley", "Aru Valley", "Sonmarg", "Gulmarg"],
    },
    {
      title: "PAHALGAM, SRINAGAR 6N 7D",
      duration: "6 Nights 7 Days",
      price: "₹ 20458",
      image:
        "https://images.unsplash.com/photo-1678774382394-9cdd44cc1876?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", // sample
      highlights: ["Betaab Valley", "Aru Valley", "Sonmarg", "Gulmarg"],
    },
    {
      title: "Silk Rout, Gangtok 5N 6D",
      duration: "5 Nights 6 Days",
      price: "₹ 0",
      image:
        "https://images.unsplash.com/photo-1599632740188-8a4f152a8342?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", // sample
      highlights: ["Scenic Roads", "Mountains", "Adventure"],
    },
    {
      title: "Varanasi, Ajodhya 6N 7D",
      duration: "6 Nights 7 Days",
      price: "₹ 10763",
      image:
        "https://plus.unsplash.com/premium_photo-1697729600773-5b039ef17f3b?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", // sample
      highlights: ["Ghats", "Temples", "River Ganga"],
    },
    {
      title: "Gangtok, Lachung, Lachen 4N 5D",
      duration: "4 Nights 5 Days",
      price: "₹ 9825",
      image: "https://images.unsplash.com/photo-1500530855697-b586d89ba3ee", // sample
      highlights: ["Snow Peaks", "Adventure", "Valleys"],
    },
  ];

  //   NEW: Trip destination image card :: End

  //   Domestic Tour & International Tour :: Start

  const tours = {
    domestic: [
      {
        name: "Sikkim",
        packages: "47 Package Tour",
        image:
          "https://plus.unsplash.com/premium_photo-1697730400710-9e565f54869e?q=80&w=1171&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      },
      {
        name: "West Bengal",
        packages: "13 Package Tour",
        image:
          "https://images.unsplash.com/photo-1610045828351-3f9737ca7bd0?q=80&w=1152&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      },
      {
        name: "Jammu & Kashmir",
        packages: "10 Package Tour",
        image:
      ...
      },
      {
        ...
        packages: "10 Package Tour",
        image:
          "https://plus.unsplash.com/premium_photo-1697730416023-3373077b9439?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      },
    ],
    international: [
      {
        ...
        packages: "5 Packages",
        image:
          "https://plus.unsplash.com/premium_photo-1697730355701-06a022eb69cd?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      },
    ],
  };

  //   Domestic Tour & International Tour :: End
    ...
    <>
      ...
      <div className="bg-white overflow-hidden relative">
        ...
        <div className="container">
          <div className="special_tour_section border border-gray-300 border-solid rounded-3xl my-16 p-4 md:p-6 md:mx-4 md:mb-8 lg:mx-4 lg:mb-8 lg:mt-0">
        ...
        <div className="">
          <div className="container">
                ...
                {packages.map((pkg, index) => (
                  ...
                  >
                    ...
                    <img
                      src={pkg.image}
                      alt={pkg.title}
                      className="w-full h-60 md:h-72 object-cover group-hover:scale-110 transition-transform duration-500"
                    />

                    {/* Duration Badge */}
                    <span className="absolute top-2 left-2 bg-gradient-to-t from-black/10 via-black/20 to-transparent  text-white text-xs px-2 py-1 rounded">
                      {pkg.duration}
                    </span>

                    {/* Hover Overlay */}
                    <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent opacity-0 group-hover:opacity-100 transition duration-500 p-4 pb-10 flex flex-col justify-end">
                      <h3 className="text-white text-[16px] font-semibold mb-2">
                        Highlighted places
                      </h3>
                      <ul className="text-white text-[12px] space-y-0">
                        {pkg.highlights.map((place, i) => (
                          <li key={i}>➤ {place}</li>
                        ))}
                      </ul>
                    </div>
                    ...
                    {/* Bottom Info */}
                    <div className="absolute bottom-0  bg-slate-500 bg-opacity-50 text-white flex justify-between w-full items-center px-3 py-2">
            ...
            {/* Old data which previous uses  :: start */}
            ...
            {/* Old data which previous uses  :: end */}
        ...
        <div className="container mx-auto px-4 my-14">
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              {tours.international.map((tour, index) => (
                <div
                  key={index}
