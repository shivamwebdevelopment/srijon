              ...
              <div className="">
                <div className="bg-white mt-5 border rounded-2xl shadow-lg p-0 py-2 md:p-6 w-full max-w-5xl">
                      ...
                      <div className="grid grid-cols-5 gap-4 justify-items-center">
                        {normalSeats.map((row, rowIndex) =>
                          row.map((seat, colIndex) => {
                            ...
                            if (seat === "G") {
                              return (
                                <div key={seatId} className="w-10 h-10"></div>
                              ); // Invisible gap
                            }
                  ...
                  ${
                    ...
                    <div className="flex-1 bg-gray-50 rounded-xl p-4 shadow-sm">
                      <h3 className="text-lg font-semibold flex items-center justify-center gap-2 mb-4">
                        <FaBed className="text-green-600" /> Sleeper Seats
                      </h3>
                      <div className="grid grid-cols-5 gap-4 justify-items-center">
                        {sleeperSeats.map((row, rowIndex) =>
                          row.map((seat, colIndex) => {
                            ...
                            if (seat === "G") {
                              return (
                                <div key={seatId} className="w-14 h-10"></div>
                              ); // Invisible gap
                            }
                            ...
                            return (
                              ...
                              >
                                <FaBed
                                  ...
                                  disabled={isSold}
                                  className={`w-11 h-9 p-2 cursor-pointer flex items-center justify-center rounded-md text-xs font-semibold transition-all
                  ${
                    isSold
                      ? "bg-gray-300 text-gray-500 cursor-not-allowed line-through"
                      : isSelected
                      ? "bg-green-600 text-white shadow-lg scale-105"
                      : "bg-white border border-green-600 text-green-600 hover:bg-indigo-100"
                  }`}
                                >
                                  {isSold ? "X" : "₹700"}
                                </FaBed>
                  ...
                  <table className="w-full border-collapse text-sm sm:text-base">
                    ...
                    <tbody>
                      ...
                      <tr className="border-b">
                        ...
                        <td className="text-center">
                          <FaBed className="text-3xl ml-2 text-green-600 border rounded-md border-green-600 w-[45px] h-[30px] p-1" />
                        </td>
                      </tr>
                      ...
                      <tr className="border-b">
                        ...
                        <td className="text-center">
                          <FaBed className="text-3xl ml-2  text-blue-700 border rounded-md border-blue-700 w-[45px] h-[30px] p-1" />
                        </td>
                      </tr>
                      ...
                      <tr className="border-b">
                        ...
                        <td className="text-center">
                          <FaBed className="text-4xl ml-2  text-gray-500 border rounded-md border-gray-500 w-[45px] h-[30px] p-1" />
                        </td>
                      </tr>
                      ...
                      <tr className="border-b">
                        ...
                        <td className="text-center">
                          <div className="w-[45px] ml-2 h-[30px] flex items-center justify-center rounded-md bg-green-600 border-2   border-green-600 ">
                      ...
                      <tr className="border-b">
                        ...
                        <td className="text-center">
                          <FaBed className="text-3xl ml-2  text-[#EF7722] border rounded-md border-[#EF7722] w-[45px] h-[30px] p-1" />
                        </td>
                      </tr>
                      ...
                      <tr className="border-b">
                        ...
                        <td className="text-center">
                          <div className="w-[45px] ml-2 h-[30px] flex items-center justify-center rounded-md bg-[#ffd8bc] border-2   border-[#ffd8bc] ">
                            <FaBed className="text-2xl  text-white" />
                          </div>
                        </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td className="text-center">
                          <div className="w-[45px] ml-2 h-[30px] flex items-center justify-center rounded-md bg-blue-300 border-2   border-blue-300 ">
                            <FaBed className="text-2xl  text-white" />
                          </div>
                        </td>
                      </tr>
