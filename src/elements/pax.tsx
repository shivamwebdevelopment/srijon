...
function Pax(props) {
    ...
    const calculatePAX = () => {
        ...
        let seasonCheckTransport = (season === 'On-season') ? 'price' : 'priceOffSeason'
    ...
    return <div style={{display:'none'}} >
        <Button style={{display:'none'}} className="mb-2" onClick={() => calculatePAX()}>Calculate PAX</Button>
        { (paxDetails.length) ? 
        ...
        <div className="grid grid-cols-5 gap-2 m-2 pb-3">
            <div><b>Solo PAX:</b><br />            
            {pax[0]} + <i>GC</i> + <i>TC</i> = <b>{pax[0] + evenPax[0] + pax[2]}</b>
            </div>
            <div><b>2 PAX:</b><br />
            {pax[1]} + <i>GC</i> + <i>TC</i> = <b>{pax[1] + evenPax[0] + pax[2]}</b>
            </div>
            <div><b>4 PAX:</b><br />
            {pax[1] * 2} + <i>GC</i> + <i>TC</i> = <b>{(pax[1] * 2) + evenPax[1] + pax[2]}</b>
            </div>
            <div><b>6 PAX:</b><br />
            {pax[1] * 3} + <i>GC</i> + <i>TC</i> = <b>{(pax[1] * 3) + evenPax[2] + pax[2]}</b>
            </div>
            <div><b>8 PAX:</b><br />
            {pax[1] * 4} + <i>GC</i> + <i>TC</i> = <b>{(pax[1] * 4) + evenPax[3] + pax[2]}</b>
            </div>
