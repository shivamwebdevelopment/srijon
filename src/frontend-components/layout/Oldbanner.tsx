                     ...
                     <div className="banner_content py-10 w-full h-full md:py-10 lg:py-20">
                        <div className="container flex justify-center items-center h-full">
                           ...
                           <div className="relative">
                              ...
                              <h1 className="text-center text-2xl font-bold text-white pb-5 md:text-4xl md:pb-6 lg:text-5xl">Plan Your Tour Now!</h1>
                                 ...
                                 <form>
                                    ...
                                    <div className="form_container flex-initial justify-center align-center text-center lg:flex">
                                       ...
                                       <div className="form_field_area mx-2 relative">
                                          <p className="form_point absolute text-white rounded-full bg-orange-500 left-8 px-3.5 py-px">From</p>
                                          <img
                                             alt="formArrowIcon"
                                             className="arrow_style absolute z-10"
                                             src={formArrowIcon}
                                          />
                                          <input className="text-black rounded-full py-6 px-9 text-sm" type="text" placeholder="Enter City or Airport" />
                                       </div>

                                       <div className="form_field_area mx-2 relative">
                                          <p className="form_point absolute text-white rounded-full bg-orange-500 left-8 px-3.5 py-px">To</p>
                                          <input className="text-black rounded-full py-6 px-9 text-sm" type="text" placeholder="Enter City or Airport" />
                                       </div>
...
<Slider {...settings}>
   ...
   <div>
      <div className="banner_section relative bg-cover bg-bottom" style={{ backgroundImage: `url(${banner01})` }}>
         <div className="banner_content py-10 w-full h-full md:py-10 lg:py-20 opacity-0">
            <div className="container flex justify-center items-center h-full">
   ...
   <div>
      <div className="banner_section relative bg-cover bg-bottom" style={{ backgroundImage: `url(${banner02})` }}>
         <div className="banner_content py-10 w-full h-full md:py-10 lg:py-20 opacity-0">
            <div className="container flex justify-center items-center h-full">
   ...
   <div>
      <div className="banner_section relative bg-cover bg-bottom" style={{ backgroundImage: `url(${banner03})` }}>
         <div className="banner_content py-10 w-full h-full md:py-10 lg:py-20 opacity-0">
            <div className="container flex justify-center items-center h-full">
   ...
   <div>
      <div className="banner_section relative bg-cover bg-bottom" style={{ backgroundImage: `url(${banner04})` }}>
         <div className="banner_content py-10 w-full h-full md:py-10 lg:py-20 opacity-0">
            <div className="container flex justify-center items-center h-full">
   ...
   {/* <div>
      <div className="banner_section relative bg-cover bg-bottom" style={{ backgroundImage: `url(${banner05})` }}>
         <div className="banner_content py-10 w-full h-full md:py-10 lg:py-20 opacity-0">
            <div className="container flex justify-center items-center h-full">
