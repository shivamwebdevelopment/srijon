...
const carListingSnippet = (props)=>{
   const imgPath = server.FILE_PATH + 'transport/';
            ...
            <div className="car_listing_box border-b border-inherit border-solid pb-6 mb-6">
                                     <div className="flex justify-between">
                                        ...
                                        <div className="w-7/12">
                                          <h2 className="text-2xl font-bold pb-4">{props.data.transportName} - <span className="text-base text-orange-500 font-medium">{props.data.transportType} / {props.data.isAC=='Y'?'AC':'Non-AC'} / {props.data.noOfseat} Seats</span></h2>
                                          <h3 className="text-lg font-bold pb-2">{props.data.departure} To {props.data.destination} ({props.data.departureTime} - {props.data.arrivalTime})</h3>
                                          <ul>
                                             <li className="flex justify-start items-center pb-2">
                                                <img
                                                   ...
                                                   src={KMIcon}
                                                />
                                                <p className="text-sm font-medium pr-16">Extra km fare</p>
                                                <span className="text-sm font-medium">₹15.0/km  <span className="text-xs font-normal text-orange-500">after</span> 148 kms</span>
                                             </li>
                                             <li className="flex justify-start items-center pb-2">
                                             <img
                                                   alt="FuelIcon"
                                                   ...
                                                   src={FuelIcon}
                                                />
                                                <p className="text-sm font-medium pr-20">Fuel Type</p>
                                                <span className="text-sm font-medium pl-2">CNG/Diesel</span>
                                             </li>
                                             <li className="flex justify-start items-center pb-2">
                                             <img
                                                   alt="CarCancelIcon"
                                        ...
                                        <div className="w-3/12 text-right">
                                          ...
                                          <h2  className="text-3xl font-bold pb-0">₹{props.data.priceSeasonAC}</h2>
...
export default carListingSnippet;